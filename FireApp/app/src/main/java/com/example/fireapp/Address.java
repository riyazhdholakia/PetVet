...
public class Address extends MainActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //------------------------------------------
        button=(Button)findViewById(R.id.viewaddressbtn);
        button.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent i = new Intent(Address.this,AddressView.class);
                Address.this.startActivity(i);
            }
        });
        ...
        mrootref1 = new Firebase("https://fireapp-f1bdd.firebaseio.com//Addresses");
